...
public class navegacionCartasNetwork : MonoBehaviour {
	...
	void Update ()
	{
		...
		if(amiga1I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga1I.GetComponent<Button>();
		}else if(amiga2I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga2I.GetComponent<Button>();
		}else if(amiga3I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga3I.GetComponent<Button>();
		}else if(amiga4I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga4I.GetComponent<Button>();
		}else if(amiga5I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga5I.GetComponent<Button>();
		}else if(amiga6I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga6I.GetComponent<Button>();
		}else if(amiga7I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga7I.GetComponent<Button>();
		}else if(amiga8I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga8I.GetComponent<Button>();
		}else if(amiga9I.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnLeft = amiga9I.GetComponent<Button>();
		}

		if(amiga1D.GetComponent<ManoJuegoNetwork>().completa)
		{ 
			navegar.selectOnRight = amiga1D.GetComponent<Button>();
		}else if(amiga2D.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnRight = amiga2D.GetComponent<Button>();
		}else if(amiga3D.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnRight = amiga3D.GetComponent<Button>();
		}else if(amiga4D.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnRight = amiga4D.GetComponent<Button>();
		}else if(amiga5D.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnRight = amiga5D.GetComponent<Button>();
		}else if(amiga6D.GetComponent<ManoJuegoNetwork>().enabled)
		{
			navegar.selectOnRight = amiga6D.GetComponent<Button>();
		}else if(amiga7D.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnRight = amiga7D.GetComponent<Button>();
		}else if(amiga8D.GetComponent<ManoJuegoNetwork>().completa)
		{
			navegar.selectOnRight = amiga8D.GetComponent<Button>();
		}else if(amiga9D.GetComponent<ManoJuegoNetwork>().completa)
		{
