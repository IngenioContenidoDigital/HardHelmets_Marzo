...
public class OrdenOffline : MonoBehaviour {
	...
	void CaminarMetra()
	{
		...
		GetComponent<AIMetra>().caminar = true;
		GetComponent<AIMetra>().lugar = lugar;
	}
	...
	void CaminarMortero()
	{
		...
		GetComponent<AIMortero>().caminar = true;
		GetComponent<AIMortero>().lugar = lugar;
	}
}
