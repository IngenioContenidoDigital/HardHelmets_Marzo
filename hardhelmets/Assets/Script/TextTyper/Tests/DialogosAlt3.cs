namespace RedBlueGames.Tools.TextTyper
{
	...
	/// </summary>
	public class DialogosAlt3 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if(idioma == "ENGLISH")
			{
				dialogueLines.Enqueue("DESTROY THE ENEMY FACILITIES");
			}
			if(idioma == "SPANISH")
			{
				dialogueLines.Enqueue("DESTRUIR LAS INSTALACIONES ENEMIGAS");
			}
			if(idioma == "CHINESE")
			{
				dialogueLines.Enqueue("破坏敌人的设施");
