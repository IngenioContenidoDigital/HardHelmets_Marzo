namespace RedBlueGames.Tools.TextTyper
{
	...
	/// </summary>
	public class DialogosAlt1 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if(idioma == "ENGLISH")
			{
				dialogueLines.Enqueue("DEPLOY AND EQUIP THE RIFLE TO CONTINUE");
			}
			if(idioma == "SPANISH")
			{
				dialogueLines.Enqueue("DESPLIEGUE Y EQUIPE EL RIFLE DE ASALTO PARA CONTINUAR");
			}
			if(idioma == "CHINESE")
			{
				dialogueLines.Enqueue("部署和设备生命周期继续");
			}
