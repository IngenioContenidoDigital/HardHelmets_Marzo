namespace RedBlueGames.Tools.TextTyper
{
	...
	public class DialogosTutorial2 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			dialogueLines.Enqueue("Durante el combate usted tendrá a su disposición una baraja de cartas de combate, las cuales podrá utilizar para tener ventaja sobre el enemigo.");
			dialogueLines.Enqueue("Seleccione el fusil de asalto reglamentario de la baraja de cartas de combate, <b>DESPLIEGUELO Y EQUIPELO SOLDADO</b>");
