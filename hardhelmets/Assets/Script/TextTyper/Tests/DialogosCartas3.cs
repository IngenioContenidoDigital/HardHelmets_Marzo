namespace RedBlueGames.Tools.TextTyper
{
	...
	/// </summary>
	public class DialogosCartas3 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if(idioma == "ENGLISH")
			{
				dialogueLines.Enqueue("Now you have some War Bonds.");
				dialogueLines.Enqueue("Enter the option <color=#EC9B00FF>War Bonds</color> to take them to battle.");
			}
			if(idioma == "SPANISH")
			{
				dialogueLines.Enqueue("Ya cuenta con algunos Bonos de Guerra.");
				dialogueLines.Enqueue("Entre a la opción <color=#EC9B00FF>Bonos de Guerra</color> para llevarlos a la batalla.");
			}
			if(idioma == "CHINESE")
			{
				dialogueLines.Enqueue("已经有更多的战争债券。");
				dialogueLines.Enqueue("输入战争债券选项让他们参战。");
			}
