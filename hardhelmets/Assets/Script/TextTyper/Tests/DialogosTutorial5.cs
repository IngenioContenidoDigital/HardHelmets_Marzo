namespace RedBlueGames.Tools.TextTyper
{
	...
	/// </summary>
	public class DialogosTutorial5 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if(idioma == "ENGLISH")
			{
				dialogueLines.Enqueue("Go to the next spot.");
			}
			if(idioma == "SPANISH")
			{
