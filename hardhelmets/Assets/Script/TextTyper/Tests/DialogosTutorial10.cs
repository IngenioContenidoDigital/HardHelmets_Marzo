namespace RedBlueGames.Tools.TextTyper
{
	...
	/// </summary>
	public class DialogosTutorial10 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if(idioma == "ENGLISH")
			{
				dialogueLines.Enqueue("Good. Keep moving to the next spot.");
			}
			if(idioma == "SPANISH")
			{
				dialogueLines.Enqueue("Bien. Muévase al siguiente punto.");
			}
			if(idioma == "CHINESE")
			{
