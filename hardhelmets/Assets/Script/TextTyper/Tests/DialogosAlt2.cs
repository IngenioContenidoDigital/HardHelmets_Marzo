namespace RedBlueGames.Tools.TextTyper
{
	...
	/// </summary>
	public class DialogosAlt2 : MonoBehaviour
	{
		...
		public void Start()
		{
			...
			if(idioma == "ENGLISH")
			{
				dialogueLines.Enqueue("DEPLOY AND EQUIP THE GRENADE TO CONTINUE");
			}
			if(idioma == "SPANISH")
			{
				dialogueLines.Enqueue("DESPLIEGUE Y EQUIPE LA GRANADA PARA CONTINUAR");
			}
			if(idioma == "CHINESE")
			{
				dialogueLines.Enqueue("部署和装备手榴弹继续");
			}
