...
public class manoJuego : MonoBehaviour {
	...
	void Start ()
	{
		...
		{
			animacion.GetComponent<skinCarta>().skinsToCombine[0] = "27";
			Load.sprite = a27;
		}
	...
	void Update ()
	{
		...
		if(Barra.GetComponent<barraOflline>().fill*100 >= costo && nomm == "inactiva")// && cantidad >= 1)
		{
			...
			if(Player.GetComponent<Hero>().salud > 0 && !amiga1.GetComponent<manoJuego>().selected && !amiga2.GetComponent<manoJuego>().selected
				&& !amiga3.GetComponent<manoJuego>().selected && !amiga4.GetComponent<manoJuego>().selected && !amiga5.GetComponent<manoJuego>().selected
				&& !amiga6.GetComponent<manoJuego>().selected && !amiga7.GetComponent<manoJuego>().selected && !amiga8.GetComponent<manoJuego>().selected
				&& !amiga9.GetComponent<manoJuego>().selected)
			{
		...
		if(selected)
		{
			amiga1.GetComponent<manoJuego>().selected = false;
			amiga2.GetComponent<manoJuego>().selected = false;
			amiga3.GetComponent<manoJuego>().selected = false;
			amiga4.GetComponent<manoJuego>().selected = false;
			amiga5.GetComponent<manoJuego>().selected = false;
			amiga6.GetComponent<manoJuego>().selected = false;
			amiga7.GetComponent<manoJuego>().selected = false;
			amiga8.GetComponent<manoJuego>().selected = false;
			amiga9.GetComponent<manoJuego>().selected = false;
		}
	...
	public void OnDragEnd ()//(PointerEventData eventData)
	{
		if(arrastrar)
		{
			...
			if(Physics.Raycast (ray, out hit, Mathf.Infinity))//if(piso.GetComponent<Collider>().Raycast (ray, out hit, Mathf.Infinity))
			{
				...
				{
					Player.GetComponent<CrearCartas>().aereo();
				}else if(nombre == "27")
				{
					Player.GetComponent<CrearCartas>().crearLlamero();
				}
				//print("Carta: "+nombre);
			}
			animacion.GetComponent<SkeletonGraphic>().AnimationState.SetAnimation(0, "entrada", false);
	...
	IEnumerator momentoselect()
	{
		...
		if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(gameObject);
		}if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga1.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga1);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga2.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga2);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga3.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga3);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga4.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga4);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga5.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga5);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga6.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga6);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga7.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga7);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga8.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga8);
		}else if(Player.GetComponent<Hero>().salud > 0 && Barra.GetComponent<barraOflline>().fill*100 >= amiga9.GetComponent<manoJuego>().costo)
		{
			Player.GetComponent<Hero>().eventsystem.GetComponent<EventSystem>().SetSelectedGameObject(amiga9);
		}
	}
