    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        ...
        public override void OnClientReady(bool readyState)
        {
            if (readyState)
            {
				...
				//readyButton.GetComponent<Image>().sprite = listo;
                readyButton.interactable = false;
		...
		void Start ()
		{
			...
			{
				CmdSendName(name, nivel, flags, bas);
			}
		}
		//PONE LOS DATOS DEL JUGADOR
		[Command]
		public void CmdSendName(string newName, int newNivel, int newFlags, int newBas)
		{
			RpcGetName (newName, newNivel, newFlags, newBas);
		}
		[ClientRpc]
		public void RpcGetName (string newName, int newNivel, int newFlags, int newBas)
		{
			if(!isLocalPlayer)
			{
				name = newName;
